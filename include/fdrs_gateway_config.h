...
// Addresses
#define UNIT_MAC            MDRS_ETH_GATEWAY_MAC    // The address of this gateway
...
#define MQTT_ACT        sendESPNowNbr(2); sendESPNowPeers(); sendSerial();
...
//#define USE_LR    // Use ESP_NOW LR mode (ESP32 only)
...
#define MQTT_ADDR "192.168.12.18"
...
//  GATEWAY CONFIGURATION
#ifdef MDRS_UART_GATEWAY

// Addresses
#define UNIT_MAC            MDRS_UART_GATEWAY_MAC    // The address of this gateway
...
#define SERIAL_ACT      sendLoRaNbr(2); broadcastLoRa();
#define MQTT_ACT
